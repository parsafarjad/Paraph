    ...
    <form className="space-y-5" onSubmit={handleSubmit((values) => mutation.mutate(values))} noValidate>
      ...
      <label className="block space-y-2">
        ...
        <div className="relative">
          <Phone className="pointer-events-none absolute right-4 top-1/2 size-5 -translate-y-1/2 text-slate-400" />
          <input
            {...register("phone")}
            className="h-12 w-full rounded-2xl border border-slate-200 bg-white pr-12 pl-4 text-left outline-none transition focus:border-sky-400 focus:ring-4 focus:ring-sky-100"
            dir="ltr"
            inputMode="tel"
      ...
      <label className="block space-y-2">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="h-12 w-full rounded-2xl border border-slate-200 bg-white pr-12 pl-12 text-left outline-none transition focus:border-sky-400 focus:ring-4 focus:ring-sky-100"
            dir="ltr"
