...
//           className="h-[37px] text-left text-[24px] font-bold leading-[37px] tracking-[-0.18px] text-[#15181a]"
//         >
  ...
  return (
    ...
    >
      <PageContainer className="flex flex-col items-start gap-8 px-0 pb-12 min-[1440px]:min-h-[633px] min-[1440px]:px-10 min-[1440px]:pb-0">
        ...
        >
          {features.map(
            ({ title, description: featureDescription, image }) => (
              <FeatureCard
                key={title}
                title={title}
...
function FeatureCard({
  ...
  return (
    <div
      className="
        group relative min-h-[230px] min-w-0 rounded-[24px]
        [perspective:1200px]
        min-[1440px]:h-[270px]
      "
    >
      ...
      <span
        aria-hidden="true"
        className="
          pointer-events-none absolute -inset-[12px] -z-10
          scale-[0.86] rounded-[34px]
          bg-[radial-gradient(circle_at_center,rgba(184,116,255,0.58)_0%,rgba(153,92,255,0.30)_42%,transparent_74%)]
          opacity-0 blur-[20px]
      ...
      <article
        tabIndex={0}
        className="
          relative isolate flex h-full min-h-[230px] min-w-0
          cursor-default flex-col items-center
          ...
          shadow-[0_0_6px_rgba(102,120,128,0.40)]
          ...
          group-hover:border-[#a277ff]
          group-hover:bg-[#eee8ff]
          group-hover:shadow-[0_0_0_1px_rgba(124,73,242,0.10),0_0_18px_rgba(153,92,255,0.48),0_0_38px_rgba(192,139,255,0.36)]

          group-focus-within:border-[2px]
          group-focus-within:border-[#a277ff]
          group-focus-within:bg-[#eee8ff]
          group-focus-within:shadow-[0_0_0_1px_rgba(124,73,242,0.10),0_0_18px_rgba(153,92,255,0.48),0_0_38px_rgba(192,139,255,0.36)]

          motion-safe:group-hover:animate-flip-in-x
          motion-safe:group-hover:animate-duration-500
          motion-safe:group-hover:animate-ease-in-out
          motion-safe:group-hover:animate-fill-mode-both

          motion-safe:group-focus-within:animate-flip-in-x
          motion-safe:group-focus-within:animate-duration-500
          motion-safe:group-focus-within:animate-ease-in-out
          motion-safe:group-focus-within:animate-fill-mode-both
      ...
      >
        ...
        <span
          ...
          className="
            pointer-events-none absolute inset-0 -z-10
            bg-[radial-gradient(circle_at_50%_45%,rgba(255,255,255,0.97)_0%,rgba(249,246,255,0.94)_35%,rgba(230,218,255,0.96)_100%)]
            opacity-0
        ...
        <span
          aria-hidden="true"
          className="
            pointer-events-none absolute left-1/2 top-[44%] -z-10
            h-[170px] w-[280px]
            -translate-x-1/2 -translate-y-1/2
            scale-75 rounded-full
            bg-white/70 opacity-0 blur-[42px]
        ...
        <div
          className="
            ...
            group-focus-within:scale-[0.72]
            group-focus-within:grayscale
          "
        >
          <Image
            src={image}
            ...
            className="
              ...
              group-hover:drop-shadow-[0_10px_16px_rgba(86,55,145,0.17)]
              group-focus-within:drop-shadow-[0_10px_16px_rgba(86,55,145,0.17)]
            "
          />
        </div>
        ...
        <div
          className="
            ...
            group-focus-within:-translate-y-[16px]
          "
        >
          <h3
            className="
              ...
              group-hover:text-[#ff302b]
              group-focus-within:text-[#ff302b]
            "
          >
            {title}
          </h3>
          ...
          <p
            className="
              ...
              group-hover:text-[#25272d]

              group-focus-within:line-clamp-3
              group-focus-within:whitespace-normal
              group-focus-within:text-[#25272d]
            "
          >
            {description}
          </p>
