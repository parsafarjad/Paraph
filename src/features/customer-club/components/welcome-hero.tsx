    ...
    <>
      ...
      >
        <PageContainer className="flex w-full items-center justify-center px-0">
          <div className="relative z-10 flex min-h-[200px] w-full max-w-[900px] items-center justify-center rounded-[36px] border border-white/80 bg-white px-5 py-8 text-center shadow-[0_12px_40px_rgba(91,104,155,0.08)] sm:rounded-[64px] sm:px-10">
            <div className="relative z-20 mx-auto w-full max-w-[690px]">
              <p className="mb-2 text-center text-[16px] leading-7 font-medium text-[#15181a]">
                {firstName} عزیز
              </p>
              ...
              <h1
                ...
                dir="rtl"
                className="font-doran text-center text-[24px] leading-[1.9] font-black text-[#7c49f2] sm:text-[30px] sm:leading-[1.8]"
              >
                <span>به </span>

                <span className="motion-safe:animate-zoom-in motion-safe:animate-duration-[2000ms] motion-safe:animate-linear motion-safe:repeat-infinite inline-block">
                  <span>پاراف کلاب</span>{" "}
                  <span className="font-thin text-[#7c49f2]">
                    (باشگاه مشتریان پاراف)
                  </span>
